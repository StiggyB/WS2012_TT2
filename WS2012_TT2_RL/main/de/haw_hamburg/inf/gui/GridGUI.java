...
public class GridGUI implements Observer {
    ...
    private void turnOtherPanelOff() {
        if (getPanel_10().getComponent(4).isEnabled()) {
            getPanel_10().getComponent(4).setEnabled(false);
        } else if (getPanel_20().getComponent(4).isEnabled()) {
            getPanel_20().getComponent(4).setEnabled(false);
        } else if (getPanel_30().getComponent(4).isEnabled()) {
            getPanel_30().getComponent(4).setEnabled(false);
        } else if (getPanel_40().getComponent(4).isEnabled()) {
            getPanel_40().getComponent(4).setEnabled(false);
        } else if (getPanel_50().getComponent(4).isEnabled()) {
            getPanel_50().getComponent(4).setEnabled(false);
        }
    }
